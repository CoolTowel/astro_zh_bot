...
dict = {'New Moon': '🌑  新月', 'First quarter': '🌓  上弦月',
        'Last quarter': '🌗  下弦月', 'Full moon': '🌕  满月'}
# 部分月相名称字典
...
def get_moonphase():
    ...
    # 获取用户年月日及LDZ
    url = 'http://www.icalendar37.net/lunar/api/?lang=en&month=' + str(month) + '&year=' + str(
        year) + '&size=100&lightColor=rgb(255,255,255)&shadeColor=rgb(17,17,17)&LDZ=' + str(LDZ)
    # 生成url
    try:
